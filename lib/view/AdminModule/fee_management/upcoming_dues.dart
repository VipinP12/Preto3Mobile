                        ...
                        child: Column(
                          children: [
                            InkWell(
                              onTap: (){
                                setState(() {
                                  expendedUpcoming = !expendedUpcoming;
                                });
                              },
                              child: Row(
                                mainAxisAlignment:
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Icon(expendedUpcoming?Icons.arrow_drop_up:Icons.arrow_drop_down),
                                        ],
                                      ),
                                    ],
                                  )
