...
class DeclinedDues extends StatefulWidget {
  const DeclinedDues({super.key});

  @override
  State<DeclinedDues> createState() => _DeclinedDuesState();
}

class _DeclinedDuesState extends State<DeclinedDues> {
