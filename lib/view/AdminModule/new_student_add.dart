...
class AddStudentsProfile extends StatefulWidget {
    const AddStudentsProfile({Key? key}) : super(key: key);

  @override
  State<AddStudentsProfile> createState() => _AdminStaffProfileState();
}

class _AdminStaffProfileState extends State<AddStudentsProfile> {

  final profileAddStudentController = Get.find<ProfileAddStudentController>();
         ...
         actions:   [
          ...
          body: Obx(()=> Padding(
            ...
            child: SingleChildScrollView(
              child: Form(
                key: profileAddStudentController.addStudentsKey,
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: GetBuilder<ProfileAddStudentController>(
                    ...
                    profileAddStudentController.allergiesList.isEmpty
                        ? Container()
                        : SizedBox(
                      height: 48,
                      width: double.maxFinite,
                    ...
                    CommonTextField(
                      ...
                      suffixImage: InkWell(
                          onTap: () {
                            print("add data");
                            profileAddStudentController.allergySession();
                          },
                          child: SvgPicture.asset(
                            AppAssets.roundedAdd,
                            fit: BoxFit.scaleDown,
                          )),
                      controller: profileAddStudentController.allergiesController,
                      onSaved: (savedValue) {
                        profileAddStudentController.allergies.value = savedValue;
                      },
                    ),
                    // Form(
                    //   key: profileAddStudentController.addAllergiesKey,
                    //   child: TextFormField(
                    ...
                    //     },
                    //     validator: (valid) {
                    //       return profileAddStudentController
                    ...
                    profileAddStudentController.medicationList.isEmpty
                        ? Container()
                        : SizedBox(
                      height: 48,
                      width: double.maxFinite,
                      ...
                      suffixImage: InkWell(
                          onTap: () {
                            print("add data");
                            profileAddStudentController.medicationSession();
                            },
                          child: SvgPicture.asset(
                            AppAssets.roundedAdd,
                            fit: BoxFit.scaleDown,
                          )),
                        controller: profileAddStudentController.medicationController,
                            onSaved: (savedValue) {
                              profileAddStudentController.medication.value =
                              savedValue;
                            },
                    ),
                    const SizedBox(
