...
class SelectStudentInvitees extends StatelessWidget {
  const SelectStudentInvitees({super.key});
                          ...
                          child: Container(
                            ...
                            child:const Column(
                              ...
                              children: [
                                CircleAvatar(
                                  radius: 40,
                                  backgroundImage:  AssetImage(AppAssets.dummyDp1)
                                ),
                                SizedBox(height: 8),
                                Text(
                                  "Name",
