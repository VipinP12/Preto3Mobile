...
class ProfileAddStaffController extends GetxController with BaseController{
  final storageBox = GetStorage();
  final addAllergiesKey = GlobalKey<FormState>();
  final addStaffKey = GlobalKey<FormState>();
  ...
  void allergySession() {
    isAllergiesValid = addStaffKey.currentState!.validate();
    Get.focusScope!.unfocus();
    if (isAllergiesValid) {
      addStaffKey.currentState!.save();
      allergiesController.clear();
      addAllergies(allergies.value);
    }
  }
  void medicationSession() {
    isMedicationValid = addStaffKey.currentState!.validate();
    Get.focusScope!.unfocus();
